...
detector_example_1 = NoisyDetector(detector_grid=focal_grid, include_photon_noise=photonnoise, flat_field=flatfield, dark_current_rate=darkcurrentrate, read_noise=readnoise)

integration_time = np.logspace(-3,3,4)
...
#Creating our detector.
detector_example_2 = NoisyDetector(detector_grid=focal_grid, include_photon_noise=photonnoise, flat_field=flatfield, dark_current_rate=darkcurrentrate, read_noise=readnoise)
